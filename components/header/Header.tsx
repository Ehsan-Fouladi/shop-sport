...
export default function Header() {
  return (
    <header className="w-full 4xl:max-w-11xl mx-auto">
      <div className="w-full h-[134px] xl:h-[197px] top-5 xl:top-10 grid grid-rows-[1fr_auto]">
        <div className="flex flex-col justify-center gap-5 xl:hidden">
          <div className="flex items-center justify-between">
            <div className="px-5 sm:px-6 lg:px-5">
              ...
              >
                <path
                  d="M0 12H16.6154V10H0V12ZM0 7H16.6154V5H0V7ZM0 0V2H16.6154V0H0Z"
                  fill="#0C0C0C"
                />
              </svg>
            </div>
            <div className="px-5 sm:px-6 lg:px-5">
              <Image
                className="block mx-auto w-[89px] h-auto"
                src="/logo.webp"
                alt="logo"
                draggable="false"
                width={89}
          ...
          <div className="xl:hidden flex justify-center items-center px-3 sm:px-4 lg:px-3">
            <SearchAutocomplete />
          </div>
        </div>
