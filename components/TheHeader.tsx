...
export default function Header() {
  return (
    <header className="w-full h-[197px] top-10 grid grid-rows-[1fr_auto] bg-base-secondary">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="w-3/4">
          <InputGroup className="rounded-[16px] border border-neutral-400 bg-neutral-100 placeholder:text-neutral-600 py-7 px-2">
        ...
        <div className="w-1/2 flex justify-center items-center gap-2">
          ...
          <div className="relative rounded-[12px] size-12 bg-base-primary flex justify-center items-center">
      ...
      <div className="w-full flex items-center justify-center">
        <nav className="w-full max-w-7xl bg-neutral-100 rounded-[16px] py-4 px-10 flex items-center justify-between">
          <ul className="font-bold text-neutral-900 text-base flex items-center shrink-0 gap-10">
            <li className="transition-all duration-200 hover:text-base-primary">
              مردانه
            </li>
            <li className="transition-all duration-200 hover:text-base-primary">
              زنانه
